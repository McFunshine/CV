...
\begin{center}
    ...
    {\color{secondary}\large \CVSubtitleGeneralNL}\\[1em]
\end{center}
...
\item \parbox{\textwidth}{\textbf{\KlinkendetaalNameNL} {\color{secondary}\small(\KlinkendetaalCompanyDescriptionNL)} \hfill \textit{\KlinkendetaalLocationNL}}\\
\textit{\KlinkendetaalJobTitleNL} \hfill \textit{\KlinkendetaalJobStartNL\,--\,\KlinkendetaalJobEndNL}

\vspace{0.1cm}
{\color{secondary}Technologieën:} \KlinkendetaalTechnologyNL
\vspace{0.2cm}
\begin{itemize}[leftmargin=*,topsep=-6pt,parsep=0pt,partopsep=0pt,itemsep=0pt]
    \item \KlinkendetaalFineTuningNL
    \item \KlinkendetaalModelSelectionNL
    \item \KlinkendetaalBenchmarkNL
    \item \KlinkendetaalDataPipelineNL
    \item \KlinkendetaalRLHFNL
    \item \KlinkendetaalKotlinEvalNL
    \item \KlinkendetaalLegacyJavaNL
\end{itemize}
